...
use App\Models\User;
use App\Services\ProductTemplates\ProductTemplatesService;
...
class LocalController extends Controller
{
    ...
    public function store(StoreLocalRequest $request): JsonResponse
    {
        $local = DB::transaction(function () use ($request) {
            ...
            app(ProductTemplatesService::class)->seedFor($local);
     ...
     */
    public function updateBilling(Request $req, Local $local): LocalResource
    {
        $data = $req->validate([
